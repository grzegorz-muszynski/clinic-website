    ...
    return (
        <div className='Diagnostics'>
            ...
            <div className="Diagnostics__wrapper">
                ...
                <p>Punkt pobrań świadczy usługi od <span>poniedziałku do czwartku</span> w godzinach <span>7:30 - 10:00</span>. Badania laboratoryjne świadczone są przez firmę <a href="https://grupadiagnostyka.pl/o-grupie/">DIAGNOSTYKA</a>.</p>
            </div>
        </div>
    )
}